...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiY2hhbmRyYXNla2FydGFtaWwyNyIsImEiOiJja3VvcDdqMm4xMGc1Mm9wMXAwdDh0ZWx5In0.fA8vx5WqyoRnswPoUa16Zg';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/chandrasekartamil27/ckuoq3vx22s8d17ryewo6lmp5',
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description, "</p>")).addTo(map); // Extends the mapbounds to include current locations
...
var stripe = window.Stripe('pk_test_51JuD8ISD7jwUDYxyxuI7AkthbfS0UMRFtqmWnW9pz4YNoMyA0UERgo40dU8TEhW4gtpz9lpcPtyagygFDTf4ZQ0C00yXVUuDZN');
